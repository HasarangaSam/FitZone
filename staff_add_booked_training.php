...
// Fetch customers and trainers for the dropdowns
$usersResult = $conn->query("SELECT id, fname, lname FROM users where userType='Customer'");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
      ...
      window.location.href = 'staff_booked_trainings.php';
      </script>";
        exit;
    } else {
...
<div class="container">
  <aside class="sidebar">
    <nav>
      ...
      <div class="nav-item" onclick="window.location.href='astaff_trainer.php'">
  ...
  <div class="main-content">
    ...
    <form action="staff_add_booked_training.php" method="POST">
        ...
        <button type="button" class="back-button" onclick="window.location.href='staff_booked_trainings.php'">Back</button>
    </form>
  </div>
</div>
