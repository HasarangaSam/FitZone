...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        echo "<script>
                ...
                window.location.href = 'staff_queries.php';
              </script>";
    } else {
        echo "<script>
                window.alert('Error: Could not update the response. Please try again.');
                window.location.href = 'staff_respond_query.php?id=$id';
              </script>";
    }
    $stmt->close();
}
...
<div class="container">
  <aside class="sidebar">
    ...
    <div class="main-content">
        ...
        <form action="staff_respond_query.php" method="POST" onsubmit="return validateResponse()">
            ...
            <button type="button" class="back-button" onclick="window.location.href='staff_queries.php'">Back</button>
        </form>
    </div>
</div>
