...
<div class="container">
  <aside class="sidebar">
    <nav>
      ...
      <div class="nav-item active" onclick="window.location.href='admin_appointments.php'">
        ...
        <table>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <a href="admin_appointments.php?delete=<?php echo $row['booking_id']; ?>" class="cancelBtn"  onclick="return confirm('Are you sure want to cancel?');">Cancel</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </table>
