...
if (isset($_GET['delete'])) {
  ...
  header("Location: admin_booked_trainings.php");
}
?>
...
<div class="container">
  <aside class="sidebar">
    ...
    <div class="main-content">
        ...
        <a href="add_booked_training.php" class="addBtn">Add New Training Booking</a>
        <table>
            <tr>
                <th>Booking Date</th>
                <th>First Name</th>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                    <a href="admin_booked_trainings.php?delete=<?php echo $row['registration_id']; ?>" class="deleteBtn"  onclick="return confirm('Are you sure want to delete?');">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </table>
